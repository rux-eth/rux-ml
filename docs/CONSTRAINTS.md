...
These are the project-specific non-negotiables established during the design session (2026-05-14 → 2026-05-15). See `docs/0.0/DESIGN-log.md` for the research trail behind each. <!-- rewrite-doc-refs:skip-line -->
