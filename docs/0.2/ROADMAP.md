...
| [PR-026](../../prs/PR-026-v0-2-0-cut.md) | **Tier-2** v0.2.0 version cut — script versioned→versioned migration (`docs/0.1/* → docs/0.2/*` in CLAUDE.md / README.md / `docs/SSOT/*`); bump `pyproject.toml` version `0.1.0 → 0.2.0`; rewrite `CHANGELOG.md` `[Unreleased]` → `[0.2.0]`; tag `v0.2.0`. Analog of PR-021 for the v0.1 cut | `[ ]` | PR-023, PR-024, PR-025, PR-027 |
