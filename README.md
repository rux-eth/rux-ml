...
**Per-PR procedure** — see `PROCEDURE-pr-research.md`. Every PR runs a state assessment before implementation; non-trivial decisions cite reputable sources. `docs/0.1/ROADMAP.md` is the PR index; `docs/0.1/RESEARCH-BACKLOG.md` tracks per-PR research status.
...
| Active design conversation log (current version) | `docs/0.1/DESIGN-log.md` |
| PR index with phases + dependencies | `docs/0.1/ROADMAP.md` |
| Per-PR research status + drift watch | `docs/0.1/RESEARCH-BACKLOG.md` |
