...
8. **Record the decision + research trail** — both go into `docs/0.3/DESIGN-log.md`
...
4. Update `docs/0.3/ROADMAP.md` to reflect new/changed PRs
5. Update `docs/0.3/RESEARCH-BACKLOG.md` to index each new PR's research status
6. Append design conversation summary + research log to `docs/0.3/DESIGN-log.md`
