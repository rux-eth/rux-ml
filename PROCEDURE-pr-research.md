...
3. Are there new PRs that must come first? Update `docs/0.2/ROADMAP.md` and create new PR files with this procedure marked pending
...
2. Did research surface prerequisite PRs? → update `docs/0.2/ROADMAP.md`, implement those first
...
The threshold is project-defined. Typical range: weeks to months. Faster-moving ecosystems warrant shorter thresholds. Record the chosen threshold in `docs/CONSTRAINTS.md` or `docs/0.2/RESEARCH-BACKLOG.md`.
