...
5. Check `docs/0.3/DESIGN-log.md` for any decisions that might have drifted
...
3. Are there new PRs that must come first? Update `docs/0.3/ROADMAP.md` and create new PR files with this procedure marked pending
...
2. Did research surface prerequisite PRs? → update `docs/0.3/ROADMAP.md`, implement those first
...
The threshold is project-defined. Typical range: weeks to months. Faster-moving ecosystems warrant shorter thresholds. Record the chosen threshold in `docs/CONSTRAINTS.md` or `docs/0.3/RESEARCH-BACKLOG.md`.
